# turn-end — release history (pre-CHANGELOG entries, verbatim)

These are the entries older than the five most recent, moved VERBATIM out of
`plugins/turn-end/RELEASE-NOTES.md` when it became
`plugins/turn-end/CHANGELOG.md` (2026-09-11). Nothing was edited or summarised — the
