# plugin-toolkit — release history (pre-CHANGELOG entries, verbatim)

These are the entries older than the five most recent, moved VERBATIM out of
`plugins/plugin-toolkit/RELEASE-NOTES.md` when it became
`plugins/plugin-toolkit/CHANGELOG.md` (2026-09-11). Nothing was edited or summarised — the
