# verifiability-lens — release history (pre-CHANGELOG entries, verbatim)

These are the entries older than the five most recent, moved VERBATIM out of
`plugins/verifiability-lens/RELEASE-NOTES.md` when it became
`plugins/verifiability-lens/CHANGELOG.md` (2026-09-11). Nothing was edited or summarised — the
