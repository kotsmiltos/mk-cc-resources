...
tests/kb-footprint.test.js   # 18 checks — THE footprint invariant: fs-import + write-site
...
- ✅ v0.7.0: SELF-RUNNING (owner: "run seed… regardless of if I've run it again… then it uses
  ...
  the archive on disk before deleting the live file, and cues an unseeded project exactly once. 256 + 37 + 40 + 46 + 38 + 18 tests.
