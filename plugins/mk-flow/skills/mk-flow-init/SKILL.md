...
| **Planned Work** | Plan file explicitly lists upcoming work (next sprint in PLAN.md Sprint Tracking, or next milestone in BUILD-PLAN.md milestone order) | Guessing what logically comes next |
