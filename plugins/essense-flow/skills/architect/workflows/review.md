...
- Task specs exist for the completed sprint
- Built artifacts exist (files created/modified during sprint)

## Steps

### 1. Gather Sprint Output
Read task specs, built files, and original requirements. Assemble what was PLANNED vs what was BUILT.
...
- **Adversarial Edge Cases:** Try to break the built code
...
For small, unambiguous, non-interface-changing fixes: apply immediately and document.
...
### 7. Plan Next Sprint
If more sprints remain: create task specs for the next sprint. Otherwise: verify all requirements addressed.
