...
| **mk-cc-all** | 2.21.0 | Bundle install — essense-flow, schema-scout, project-note-tracker, session-lifecycle, plugin-toolkit. essense-autopilot, thorough-mode, alert-sounds, and verifiability-lens carry hooks and must be installed separately. |
