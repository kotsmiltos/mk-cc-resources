...
| **mk-cc-all** | 2.26.0 | Bundle install — essense-flow, schema-scout, project-note-tracker, session-lifecycle, plugin-toolkit, kb. essense-autopilot, thorough-mode, alert-sounds, verifiability-lens, reuse-gate, and steward carry hooks and must be installed separately. |
